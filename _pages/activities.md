...
* 41st ACM/IEEE International Conference on Automated Software Engineering ([ASE 2026](https://conf.researchr.org/home/ase-2026){:target="_blank"}), Review Process Co-Chair
* 20th ACM/IEEE International Conference on Software Engineering for Adaptive and Self-Managing Systems ([SEAMS 2025](https://conf.researchr.org/home/seams-2025){:target="_blank"}), Program Committee Co-Chair (Research Track)
* GI-Fachtagung Software Engineering ([SE 2023](https://se-2023.gi.de/){:target="_blank"}), Workshop Co-Chair
...
* GI-Dagstuhl Seminar on Software Engineering for Intelligent and Autonomous Systems, [Seminar 18343](http://www.self-adaptive.org/dagstuhl-seminars/sefias/){:target="_blank"}, 2018, Co-Organizer
* 13th ACM/IEEE International Symposium on Software Engineering for Adaptive and Self-Managing Systems ([SEAMS 2018](http://2018.seams-symposia.org){:target="_blank"}), Publicity Co-Chair, Web Chair, and Social Media Chair
* GI-Dagstuhl Seminar on Software Engineering for Self-Adaptive Systems, [Seminar 14433](http://www.self-adaptive.org/dagstuhl-seminars/sefsas4jr/){:target="_blank"}, 2014, Co-Organizer
* Workshop on Current Trends, Challenges, and Solutions in Model-Driven Engineering ([MDE 2014](https://www.hpi.uni-potsdam.de/giese/events/mde2014/){:target="_blank"}), Web Chair
* 6th ACM/IEEE International Symposium on Software Engineering for Adaptive and Self-Managing Systems ([SEAMS 2011](https://www.hpi.uni-potsdam.de/giese/events/seams2011/){:target="_blank"}), Publicity Co-Chair
...
* **ACM/IEEE International Conference on Software Engineering for Adaptive and Self-Managing Systems (SEAMS)** <br/> Research Track (2018-2024, 2026-2027), Artifacts (2015, 2023)
* **IEEE International Conference on Software Testing, Verification and Validation (ICST)** <br/> Research Track (2022-2025, 2027), Vision and Emerging Results Track (2026), Testing Tools and Data Showcase Track (2026)
...
* **European Conference on Software Architecture (ECSA)** <br/> Doctoral Symposium (2016, 2021), Posters, Tools & Demos (2019)
* **Annual Modeling and Simulation Conference (ANNSIM)** <br/> Theory and Foundations of Modeling and Simulation (TMS) Track (2021)
* **Brazilian Symposium on Software Components, Architectures and Reuse (SBCARS)**, 2018-2019
* **IEEE International Conference on Autonomic Computing (ICAC)** / **IEEE International Conference on Self-Adaptive and Self-Organizing Systems (SASO)** <br/> Posters and Demos (2018-2019)
* **ACM International Symposium on the Foundations of Software Engineering (FSE)** <br/> Demo Track (2016)


### Workshops

* **International ICSE Workshop on Search-Based and Fuzz Testing (SBFT)**, 2020-2026
* **Workshop on Automotive Software Engineering**, 2022-2026
* **Software Engineering im Unterricht der Hochschulen (SEUH)**, 2023
* **ACSOS Workshop on Self-Aware Computing (SeAC)**, 2020-2021
* **ACSOS Workshop on Self-Protecting Systems (SPS)**, 2021
...
* **International Workshop on Concurrency, Specification and Programming (CS&P)**, 2021
* **ACSOS Workshop on Cyber Resilience and Antifragility in Complex, Distributed Systems (CyRA)**, 2020
* **International ASE Workshop on Explainable Software (EXPLAIN)**, 2019
* **Modellierung**, Praxisforum (2018)
* **MODELS Workshop on Model-Driven Engineering Tools (MDETools)**, 2017-2018
* **MODELS Workshop on Models@run.time (MRT)**, 2014-2018
* **Joint International ICAC/SASO Workshop on Models@run.time and Self-aware Computing Systems (MRT-SeAC)**, 2018
* **International ICAC Workshop on Models@run.time for Self-aware Computing Systems (MRT-ICAC)**, 2016-2017
* **International MODELS Workshop on Open Source Software for Model-Driven Engineering (OSS4MDE)**, 2016
* **International ESEC/FSE Workshop on Control Theory for Software Engineering (CTSE)**, 2015
...
* **ACM/IEEE International Conference on Software Engineering (ICSE)**, 2009-2010, 2012, 2019-2020, 2026
* **ACM/IEEE International Conference on Model Driven Engineering Languages and Systems (MODELS)**, 2009-2014
* **ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering (ESEC/FSE)**, 2011, 2018-2019
* **ACM/IEEE International Conference on Automated Software Engineering (ASE)**, 2017-2019
* **ACM/IEEE International Workshop/Symposium/Conference on Software Engineering for Adaptive and Self-Managing Systems (SEAMS)**, 2009-2010, 2012-2017
* **International Conference on Fundamental Approaches to Software Engineering (FASE)**, 2010, 2012, 2014
* **IEEE International Conference on Autonomic Computing (ICAC)**, 2009

<!-- Other external review activities:
* 2018: SSBSE
* 2017: Journal of Software: Evolution and Process
* 2016: SASO
* 2015: DADS/SAC, SEsCPS, SERENE, Modes@run.time
* 2014: Science of Computer Programming, ICSME, CyPhy, ModTools
* 2013: TSE, JSS, FORTE/FMOODS, FORMATS, ICSM, DADS/SAC, Models@run.time
* 2012: SOSYM, COORDINATION, DADS/SAC, Models@run.time, FOCLASA
* 2011: ICPE, FMOODS/FORTE, MOCS/SEAA, DADS/SAC
* 2010: Science of Computer Programming, ECSA, DEPEND, MOCS/SEAA, SIMPAR, DADS/SAC, Models@run.time, QUASOSS, MBEES, AOSE
* 2009: AAMAS, SEKE, ICSE Demo Track, DADS/SAC, MISE, SOAR, WADS
-->
